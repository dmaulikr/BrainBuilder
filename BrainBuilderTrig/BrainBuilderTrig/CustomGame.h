...
-(void) learnSettings:(NSInteger *)sin: (NSInteger *)cos: (NSInteger *)tan: (NSInteger *)csc: (NSInteger *)sec: (NSInteger *)cot: (NSInteger *)quad1: (NSInteger *)quad2: (NSInteger *) quad3: (NSInteger *)quad4: (NSInteger *)rad;
-(void) setUp;
...
@property (retain, nonatomic) UITextView *tester;
