...
@synthesize rightAnswers, wrongAnswers, limit, question;
@synthesize buttonA, buttonB, buttonC, buttonD;
@synthesize object, highScores;

- (instancetype)init
{
    self = [super initWithNibName:@"GamePage" bundle:nil];
    if (self) {
...
-(void) upDate
{
    ...
    limit.text = [object limit:randomNumb];
    question.text = [object question:randomNumb];
    [self setUpButtons];
}
