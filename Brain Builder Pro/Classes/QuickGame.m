...
@synthesize equals;
@synthesize equals2;
@synthesize wrongAnswerGenerator;
...
-(void) createProblem2
{
    ...
    [wrongAnswerGenerator Create:answr];
	
	if (true)
	{
		if (choice3 == 0) 
		{
            AA = [wrongAnswerGenerator wrongAnswer1];
			//AA = answr + (arc4random()%10 + 1);
			BB = answr;
            
			//CC = answr * (arc4random()%3 + 2);
            CC = [wrongAnswerGenerator wrongAnswer2];
            
			//DD = answr - (arc4random()%10 + 1);
            DD = [wrongAnswerGenerator wrongAnswer3];
			Result3 = 2;
		}
		else if (choice3 == 1)
		{
            ...
            BB = [wrongAnswerGenerator wrongAnswer1];
		...
		else if (choice3 == 2)
		{
			...
			//BB = answr  - (arc4random()%10 + 1);
            BB = [wrongAnswerGenerator wrongAnswer2];
		...
		else if (choice3 == 3)
		{
			...
			//CC = answr + (arc4random()%10 + 1);
            CC = [wrongAnswerGenerator wrongAnswer3];
