...
- (void)viewDidLoad
{
	...
	if (Know == 1)
	{
        ...
        CGRect rect = {130, 45, 125, 25};
        //UITextField *dirField = [[UITextField alloc] initWithFrame:rect];
        theName = [[UITextField alloc] initWithFrame:rect];
        //dirField.backgroundColor = [UIColor whiteColor];
        theName.backgroundColor = [UIColor whiteColor];
        //[dirField becomeFirstResponder];
        [theName becomeFirstResponder];
        //[setHighScore addSubview:dirField];
        [setHighScore addSubview:theName];
        //theName.text = dirField.text;
        /*
		theName = [[UITextField alloc] initWithFrame:CGRectMake(0.0f, 0.0f, 250.0f, 30.0f)];
